 ...
 * @subpackage Simple_Survey_Manager/public
 */
 ...
 */
class Simple_Survey_Manager_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/simple-survey-manager-public.css', array(), $this->version, 'all' );
